        ...
        <div>
            ...
            <div className="space-y-2">
                ...
                <div className="bg-slate-100 dark:bg-slate-700 rounded-full overflow-hidden">
                    {/* // aria-valuemax="4550" aria-value-min="0" aria-valuenow="1456" */}
                    <div className="bg-cyan-500 dark:bg-cyan-400 w-1/2 h-2" role="progressbar" aria-label="music progress" ></div>
                </div>
